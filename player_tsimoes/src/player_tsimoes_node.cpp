    ...
    class Player
    {
        public:
            ...
            tf::Transform getPose(void)
            {
                ...
                try{
                    listener.lookupTransform("/map", name, ros::Time(0), st);//dizer a transformação da posição no segundo
                }
...
} //end of namespace rws2016_tsimoes
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "tf_tsimoes_node");
    ros::NodeHandle node;
